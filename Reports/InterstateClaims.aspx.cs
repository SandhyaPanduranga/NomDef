...
public partial class InterstateClaims : System.Web.UI.Page
{
    ...
    protected void ButtonSearch_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                String AccidentFromText = AccidentFrom.Year.ToString() + "-" + AccidentFrom.Month.ToString() + "-" + AccidentFrom.Day.ToString();
                String AccidentToText = AccidentTo.Year.ToString() + "-" + AccidentTo.Month.ToString() + "-" + AccidentTo.Day.ToString();
                ...
                SqlCommand myCommand = new SqlCommand("SELECT ND.ClaimantFirstName, ND.ClaimantLastName, ND.ClaimNumber as NDReferenceNo, convert (varchar, ND.AccidentDate, 103) as DateofAccident, Ins1.InsurerName as NSWManagingInsurerName, UPPER(VehInv.RegistrationNumber) as RegistrationNo,AUS.State as RegistrationState,Ins2.InsurerName as InterstateCTPInsurerName  FROM NDF.dbo.NominalDefendants ND,NDF.dbo.VehiclesInvolved VehInv,NDF.dbo.Insurers Ins1,NDF.dbo.Insurers Ins2,NDF.dbo.AustralianStates AUS WHERE ND.AllocatedInsurerId = Ins1.InsurerId AND ND.ID = VehInv.Ndid AND AUS.ID = VehInv.RegistrationState AND VehInv.InsurerId = Ins2.InsurerId AND VehInv.RegistrationState not in (1, 2) AND VehInv.AtFault = 'True'AND ND.AccidentDate >= '" + AccidentFromText + "' AND ND.AccidentDate <= '" + AccidentToText + "' ORDER BY ND.AccidentDate,ClaimantFirstName", myConnection);
                ...
                if (rowCount)
                {
                    ...
                    TitleLabel.Text += "Interstate Claims between " + AccidentFrom.Day.ToString() + "/" + AccidentFrom.Month.ToString() + "/" + AccidentFrom.Year.ToString() + " and " + AccidentTo.Day.ToString() + "/" + AccidentTo.Month.ToString() + "/" + AccidentTo.Year.ToString() + "<br /><br />";
                    TestPlaceholder.Controls.Add(TitleLabel);

                    myReaderCount.Read();
                    TotalClaims = Convert.ToDecimal(myReaderCount["NumberofClaims"]);
                    ...
                    TableCell cell7Title = new TableCell(); // Registration State                                                            
                    TableCell cell8Title = new TableCell(); // Interstate CTP InsurerName                                                            
                    ...
                    cell5TitleText.Text = "<strong>NSW Managing Insurer Name</strong>";
                    ...
                    cell6Title.Width = 100;
                    cell6Title.CssClass = "tableTitle";
                    rowTitle.Cells.Add(cell6Title);

                    cell7TitleText.Text = "<strong>Registration State</strong>";
                    cell7Title.Controls.Add(cell7TitleText);
                    cell7Title.Width = 50;
                    cell7Title.CssClass = "tableTitle";
                    rowTitle.Cells.Add(cell7Title);

                    cell8TitleText.Text = "<strong>Interstate CTP InsurerName</strong>";
                    cell8Title.Controls.Add(cell8TitleText);
                    cell8Title.Width = 100;
                    cell8Title.CssClass = "tableTitle";
                    rowTitle.Cells.Add(cell8Title);
                    ...
                    while (myReader.Read())
                    {
                        ...
                        TableCell cell8Disp = new TableCell();
                        ...
                        cell2Disp.Style.Value = "text-transform:uppercase";
                        ...
                        cell7DispText.Text = myReader["RegistrationState"].ToString();
                        cell7Disp.Controls.Add(cell7DispText);
                        cell7Disp.CssClass = "tableField";
                        rowDisp.Cells.Add(cell7Disp);


                        Literal cell8DispText = new Literal();
                        cell8DispText.Text = myReader["InterstateCTPInsurerName"].ToString();
                        cell8Disp.Controls.Add(cell8DispText);
                        cell8Disp.CssClass = "tableField";
                        rowDisp.Cells.Add(cell8Disp);
                    ...
                    TableCell cell8Total = new TableCell();
                    ...
                    cell8TotalText.Text = " ";
                    cell8Total.Controls.Add(cell8TotalText);
                    cell8Total.Width = 50;
                    cell8Total.CssClass = "tableTitle";
                    rowTotal.Cells.Add(cell8Total);
                ...
                {
                    Label NoRowsLabel = new Label();
                    NoRowsLabel.Text = "<strong> No rows found for the period you selected.</strong><br /><br />";
                    TestPlaceholder.Controls.Add(NoRowsLabel);
                }
                myReaderCount.Close();
                myReader.Close();
                myConnection.Close();
