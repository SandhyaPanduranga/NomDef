<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="True" Inherits="Test" Codebehind="Test.aspx.cs" %>
...
<asp:Label ID="tmpLabel" runat="server"></asp:Label>
    <table>
        <tr>
            ...
            <span style="vertical-align:bottom" class="textboxEntryShort"><a style="cursor:pointer" onclick="show_calendar('document.forms[0].ctl00$MainContent$AccidentFromDate', '');"><img src="/Images/dates.gif" alt="Select Date" id="Img2" /></a></span>
            </td>
            <td>To: <asp:TextBox ID="AccidentToDate" runat="server" CssClass="textboxEntryShort"></asp:TextBox>
            <span style="vertical-align:bottom" class="textboxEntryShort"><a style="cursor:pointer" onclick="show_calendar('document.forms[0].ctl00$MainContent$AccidentToDate', '');"><img src="/Images/dates.gif" alt="Select Date" id="Img3" /></a></span> 
            </td>
         </tr>
        <tr>
    ...
    <asp:SqlDataSource ID="TestDataSource" runat="server" 
        ...
        SelectCommand="SELECT * FROM [Insurers]">
    </asp:SqlDataSource>
     <br />
